...
magiskpolicy --live "dontaudit { system_lib_file vendor_file vendor_configs_file same_process_hal_file } labeledfs filesystem associate"
magiskpolicy --live "allow     { system_lib_file vendor_file vendor_configs_file same_process_hal_file } labeledfs filesystem associate"
...
magiskpolicy --live "dontaudit init { system_lib_file vendor_file vendor_configs_file same_process_hal_file } file relabelfrom"
